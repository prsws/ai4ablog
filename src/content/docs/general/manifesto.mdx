...
description: Why Pepa exists — a self-hosted cognitive infrastructure that helps an older adult remember, organize, and stay independent, without sending anything to the cloud.
template: doc
